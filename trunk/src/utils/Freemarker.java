...
public class Freemarker {
	 ...
	 */
	public static void printFile(String ftlName, Map<String,Object> root, String outPath,String outFile) throws Exception{
		try {
			File file = new File(outPath + File.separator + outFile);
	...
	public static Template getTemplate(String ftlName) throws Exception{
		try {
			...
			cfg.setDirectoryForTemplateLoading(new File(Freemarker.getClassResources()+"../ftl/"));		//设定去哪里读取相应的ftl模板文件
	...
	private static String getClassResources(){
		return Freemarker.class.getResource("/").getPath();
	}
}
